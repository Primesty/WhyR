...
If the packages do not load or you get an error message, please install them one-by-one through the 'packages' tab and then the 'install' tab in the lower-right window in RStudio.

The next couple of lines of code load the packages you are going to need for all the fun stuff...
...
### Alternatively (or additionally), we can overlay a density curve and the normal distribution
